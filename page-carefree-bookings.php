...
<section class="container-fluid carefree">
    ...
    <li class="nav-item">
        <a class="nav-link active" id="hotels-tab" data-toggle="tab" href="#hotels" role="tab" aria-controls="hotels" aria-selected="true">Hotels</a>
    </li>
    <li class="nav-item">
    ...
    <div class="tab-content" id="myTabContent">
        <div class="tab-pane fade show active" id="hotels" role="tabpanel" aria-labelledby="hotels-tab">
            <div class="row">
                ...
                <a href="<?php the_field('search_hotels_url') ;?>" class="btn btn-primary btn-sm">Search All Hotels</a>
            </div>
        ...
        <p><?php the_field('support_subtitle'); ?></p>
            <div class="row">
                ...
                <div class="col-md-12">
                    <h3><?php the_field('support_contact') ;?></h3>
                </div>
            </div>
        </section>
        </div>
